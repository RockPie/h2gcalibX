...
print("")
print("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
print(">>>                                                             Test Script for Generator Mode - 006_10G_Test_GEN.py                                                                                                                          <<<")
print("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
print("")
...
CFG_DAQ[6+15] = 0x04  # GENERATOR PRE INTERVAL  7:0
...
CFG_DAQ[6+19] = 0x08  # GENERATOR NR OF CYCLE  7: 0
...
CFG_DAQ[6+23] = 0x0A  # GENERATOR INTERVAL  7: 0
...
CFG_DAQ[6+2]  = 0x09  # DAQ + GENERATOR START/STOP -
CFG_DAQ[6+4]  = 0x00  # DAQ PUSH - ASIC7:ASIC0
CFG_DAQ[6+5]  = 0x01  # b0 - GENERATOR START/STOP
CFG_DAQ[6+6]  = 0x03  # DAQ START/STOP - ASIC7:ASIC0
...
while True:
    try:
        datadq, add = s.recvfrom(8192)
        convert = bytes.hex(datadq)
...
print("Received Packets: %s: " % (PacketCount))
print("")
