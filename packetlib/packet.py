...
req_get_proto_monitor_code  = 0x30
req_set_proto_off_code      = 0x31
...
def pack_data_req_proto_monitor(header, fpga_address):
    return struct.pack(req_get_proto_monitor, header, fpga_address, req_get_proto_monitor_code)

def pack_req_proto_monitor_off(header, fpga_address):
    return struct.pack(req_set_monitoring_off, header, fpga_address, req_set_proto_off_code, 0x00, 0x00)

def pack_req_proto_monitor_on(header, fpga_address):
    return struct.pack(req_set_monitoring_on, header, fpga_address, req_set_proto_off_code, 0x1f, 0x1f)
...
def unpack_data_rpy_proto_monitor(data):
    unpacked_data           = struct.unpack(rpy_get_proto_monitor_format, data)
    header                  =  unpacked_data[0]
    fpga_address            =  unpacked_data[1]
    packet_type             =  unpacked_data[2]
    if packet_type != req_get_proto_monitor_code:
        print("Invalid packet type" + str(packet_type))
        return None

    enable                  =  unpacked_data[3]
    a0_vbus_19_12           =  unpacked_data[5]
    a0_vbus_11_4            =  unpacked_data[6]
    a0_vbus_0_3             =  unpacked_data[7] >> 4 & 0x0F
    a0_vshunt_19_16         =  unpacked_data[7] & 0x0F 
    a0_vshunt_15_8          =  unpacked_data[8]
    a0_vshunt_7_0           =  unpacked_data[9]
    a0_temp_15_8            =  unpacked_data[10]
    a0_temp_7_0             =  unpacked_data[11]
    a1_vbus_19_12           =  unpacked_data[12]
    a1_vbus_11_4            =  unpacked_data[13]
    a1_vbus_0_3             =  unpacked_data[14] >> 4 & 0x0F
    a1_vshunt_19_16         =  unpacked_data[14] & 0x0F 
    a1_vshunt_15_8          =  unpacked_data[15]
    a1_vshunt_7_0           =  unpacked_data[16]
    a1_temp_15_8            =  unpacked_data[17]
    a1_temp_7_0             =  unpacked_data[18]
    a2_vbus_19_12           =  unpacked_data[19]
    a2_vbus_11_4            =  unpacked_data[20]
    a2_vbus_0_3             =  unpacked_data[21] >> 4 & 0x0F
    a2_vshunt_19_16         =  unpacked_data[21] & 0x0F 
    a2_vshunt_15_8          =  unpacked_data[22]
    a2_vshunt_7_0           =  unpacked_data[23]
    a2_temp_15_8            =  unpacked_data[24]
    a2_temp_7_0             =  unpacked_data[25]
    a3_vbus_19_12           =  unpacked_data[26]
    a3_vbus_11_4            =  unpacked_data[27]
    a3_vbus_0_3             =  unpacked_data[28] >> 4 & 0x0F
    a3_vshunt_19_16         =  unpacked_data[28] & 0x0F 
    a3_vshunt_15_8          =  unpacked_data[29]
    a3_vshunt_7_0           =  unpacked_data[30]
    a3_temp_15_8            =  unpacked_data[31]
    a3_temp_7_0             =  unpacked_data[32]
    a4_vbus_19_12           =  unpacked_data[33]
    a4_vbus_11_4            =  unpacked_data[34]
    a4_vbus_0_3             =  unpacked_data[35] >> 4 & 0x0F
    a4_vshunt_19_16         =  unpacked_data[35] & 0x0F 
    a4_vshunt_15_8          =  unpacked_data[36]
    a4_vshunt_7_0           =  unpacked_data[37]
    a4_temp_15_8            =  unpacked_data[38]
    a4_temp_7_0             =  unpacked_data[39]

    a0_vbus               = (a0_vbus_19_12 << 12) | (a0_vbus_11_4 << 4) | a0_vbus_0_3
    a1_vbus               = (a1_vbus_19_12 << 12) | (a1_vbus_11_4 << 4) | a1_vbus_0_3
    a2_vbus               = (a2_vbus_19_12 << 12) | (a2_vbus_11_4 << 4) | a2_vbus_0_3
    a3_vbus               = (a3_vbus_19_12 << 12) | (a3_vbus_11_4 << 4) | a3_vbus_0_3
    a4_vbus               = (a4_vbus_19_12 << 12) | (a4_vbus_11_4 << 4) | a4_vbus_0_3
    a0_vshunt             = (a0_vshunt_19_16 << 16) | (a0_vshunt_15_8 << 8) | a0_vshunt_7_0
    a1_vshunt             = (a1_vshunt_19_16 << 16) | (a1_vshunt_15_8 << 8) | a1_vshunt_7_0
    a2_vshunt             = (a2_vshunt_19_16 << 16) | (a2_vshunt_15_8 << 8) | a2_vshunt_7_0
    a3_vshunt             = (a3_vshunt_19_16 << 16) | (a3_vshunt_15_8 << 8) | a3_vshunt_7_0
    a4_vshunt             = (a4_vshunt_19_16 << 16) | (a4_vshunt_15_8 << 8) | a4_vshunt_7_0
    a0_temp               = (a0_temp_15_8 << 8) | a0_temp_7_0
    a1_temp               = (a1_temp_15_8 << 8) | a1_temp_7_0
    a2_temp               = (a2_temp_15_8 << 8) | a2_temp_7_0
    a3_temp               = (a3_temp_15_8 << 8) | a3_temp_7_0
    a4_temp               = (a4_temp_15_8 << 8) | a4_temp_7_0
